...
export class Backend implements backendInterface {
    ...
    async addOrUpdateOfficer(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addOrUpdateOfficer(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getMessagePayload(arg0: string, arg1: string): Promise<{
        mobileNumber: string;
        message: string;
    }> {
        if (this.processError) {
            try {
                const result = await this.actor.getMessagePayload(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getOfficers(): Promise<Array<Officer>> {
        if (this.processError) {
            try {
                const result = await this.actor.getOfficers();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async removeOfficer(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.removeOfficer(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
